...
//     version 1.3.0
//     from Assets/Scripts/InputSystem/Metalink Default Action.inputactions
//
...
public partial class @MetalinkDefaultAction : IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @MetalinkDefaultAction()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""Metalink Default Action"",
    ""maps"": [
        {
            ""name"": ""XRI Head"",
    ...
    {
        private @MetalinkDefaultAction m_Wrapper;
        public XRIHeadActions(@MetalinkDefaultAction wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @MetalinkDefaultAction m_Wrapper;
        public XRILeftHandActions(@MetalinkDefaultAction wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @MetalinkDefaultAction m_Wrapper;
        public XRILeftHandInteractionActions(@MetalinkDefaultAction wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @MetalinkDefaultAction m_Wrapper;
        public XRILeftHandLocomotionActions(@MetalinkDefaultAction wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @MetalinkDefaultAction m_Wrapper;
        public XRIRightHandActions(@MetalinkDefaultAction wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @MetalinkDefaultAction m_Wrapper;
        public XRIRightHandInteractionActions(@MetalinkDefaultAction wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @MetalinkDefaultAction m_Wrapper;
        public XRIRightHandLocomotionActions(@MetalinkDefaultAction wrapper) { m_Wrapper = wrapper; }
